...
$id_data2 = $_GET['id'];
$link = "tapping_agree.php?id=".$id_data2;
...
if (isset($ubah_tapping_agree)) {
    ...
    if ($username != NULL or $username != "") {
		...
		$query1 = "insert into app_tam_t2 (tgl, login, nama, no_pelanggan, fastel, nama_dm, tlp, site, reg, jenis, status, kategori, reason, penerima, 
        ket, follow, upd_qco, rec_qco, tgl_qco1, valid, input, lup, upd, status_t2, kat_t2, alasan, rekom_t2) VALUES 
        ('$tgl', '$login', '$nama', '$no_pelanggan', '$fastel', '$nama_dm', '$tlp', '$site', '$reg', '$jenis', '$status', '$kategori', '$reason', '$penerima', 
        '$ket', '$follow', '$upd_qco', '$rec_qco', '$tgl_qco1', '$valid', '$input', '$lup', '$upd', '$status_t2','$kat_t2', '$alasan_agree', '$rekom_t2' )";
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?=$link?>" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                <h4 class="card-title">Data Detail Approve</h4>
                                <br>
								...
								<h4 class="card-title">Tapping Approve</h4>
                                <br>
                                <div class="form-group row">
								...
								<div class="form-group row">
                                    <label class="col-md-2" for="">Kategori NOK</label>
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <select name="kat_t2" class="form-control" placeholder="Pilih kategori" id="kat_t2">
                                                        <option value="" selected>-- Pilih kategori</option>
                                                        <option value="Penanggung Jawab">Penanggung Jawab</option>
                                                        <option value="Penawaran">Penawaran</option>
														<option value="Pernyataan Kesediaan">Pernyataan Kesediaan</option>
                                 ...
                                 <div class="form-group row">
                                    <label class="col-md-2" for="alasan_agree">Sub Kategori NOK</label>
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                     <select name="alasan_agree" class="form-control" placeholder="Pilih subkat" id="alasan_agree">
                                                        <option value="" selected>-- Pilih subkat --</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-actions">
                                <div class="text-left">
                                    <button type="submit" name="ubah_tapping_agree" class="btn btn-info" value="1">Simpan Tapping Approve</button>
