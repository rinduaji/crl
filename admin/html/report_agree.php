    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Approve Closed</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a href="index.html" class="text-muted">Report</a></li>
                            <li class="breadcrumb-item text-muted active" aria-current="page">Tapping Approve</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="table1" class="display">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT id, lup, tgl, upd, nama, login, fastel, nama_dm, jenis, tlp, site, status_t2, alasan, rekom_t2, kat_t2 FROM app_tam_t2 WHERE status='Contacted' AND kategori='Agree' AND valid='Valid' AND lup BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY lup DESC";
