                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item text-muted active" aria-current="page">Approve</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="table1" class="display">
                                ...
                                <tbody>
                                    ...
                                    $total_hasil_agent_t2 = mysqli_num_rows($sql_hasil_agent_t2);
                                    ...
                                    $i = 0;
                                    $sql_fastel = "select fastel, upd from app_tam_t2 where tgl between '$yesterday_awal' and '$yesterday_akhir' and valid='Valid' AND `status`='Contacted' AND kategori = 'Agree' AND upd='$upd' ORDER BY tgl ASC";
                                    ...
                                    // $sql = "(SELECT a.id, a.tgl, a.login, b.user2, a.fastel, a.nama_dm, a.jenis, a.tlp, b.user5, a.kategori FROM app_tam_data2 AS a INNER JOIN cc147_main_users_extended AS b ON a.login = b.user1
									// 		WHERE a.tgl between '$yesterday_awal' and '$yesterday_akhir' and  a.valid='Valid' AND a.`status`='Contacted' AND a.kategori = 'Agree' 
									// 		AND a.follow='6' AND b.user1 <> '143272' AND b.user1 <> '31184' AND b.user1 <> '92734' and a.jenis<>'SMOOA' and a.jenis<>'PSB IH' and a.jenis<>'P2P' ORDER BY a.tgl ASC limit 310)
									// 		union all
									// 		(SELECT a.id, a.tgl, a.login, b.user2, a.fastel, a.nama_dm, a.jenis, a.tlp, b.user5, a.kategori FROM app_tam_data2 AS a INNER JOIN cc147_main_users_extended AS b ON a.login = b.user1
									// 		WHERE a.tgl between '$yesterday_awal' and '$yesterday_akhir' and  a.valid='Valid' AND a.`status`='Contacted' AND a.kategori = 'Agree' 
									// 		AND a.follow='6' AND b.user1 <> '143272' AND b.user1 <> '31184' AND b.user1 <> '92734' and (a.jenis = 'SMOOA'  or a.jenis = 'PSB IH' or a.jenis = 'P2P') limit 10)";
                                    ...
                                    $pembagian_data = ceil($total / $total_hasil_agent_t2);
                                    // print_r($pembagian_data.'<br>');
                                    if ($upd != '143272') {
                                        if ($upd != '31184') {
                                            if ($total > 0) {
                                                while ($row = mysqli_fetch_array($sql_hasil)) {
                                                    $check = 0;
                                                    $link_tapping = $row['kategori'] == 'Agree' ? 'tapping_agree.php' : 'tapping_decline.php';
                                    ...
                                    ?>
                                                ...
                                                <?php
                                                    ...
                                                    $bagi++;
                                                    // print_r($bagi.' '.$array_agent_t2[$i].' '.$row['login'].'<br>');
                                                    if ($bagi % $pembagian_data == 0) {
                                                        $bagi = 0;
                                                        $i++;
                                                    }
                                                }
