...
if (isset($ubah_tapping_ps)) {
    if ($login != NULL or $login != "") {
        ...
        rapi = '$rapi', saran='$saran', lup='$tanggal_now', input='1', status_call='$status_call', nama_pelanggan='$nama_plg', ket_tamb='$ket_tamb',relasi = '$relasi',channel_favorit='$channel_favorit_pelanggan' WHERE id = '$id'";
                    ...
                    <div class="card-body">
                        <form action="tapping_ps.php" method="post" enctype="multipart/form-data">
                            <div class="form-body">
								...
								<div class="form-group row">
                                    <label class="col-md-2" for="nama_plg">Nama Penerima </label>
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="nama_plg" class="form-control" placeholder="Masukkan nama penerima" id="nama_plg">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
								...
								<div class="form-group row">
                                    <label class="col-md-2" for="ket_tamb">Keterangan Tambahan  </label>
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="ket_tamb" class="form-control" placeholder="Masukkan Keterangan" id="ket_tamb">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
