...
$sql = "SELECT id, lup, login, addon, nd_speedy, no_hp, status_call, status, umur, channel, nama_pelanggan, relasi, alasan_cabut, kualitas_produk, penyampaian, mengerti_produk, saran, detail1, detail2, proses_cabut, proses_cabut2, kcontact_cabut  
...
if(isset($_GET['status'])) {
    if($_GET['status'] == 'succes') {
        header("Location: fform_wo_tappingsurvey.php");
    }
}
                    ...
                    <div class="card-body">
                        <form action="tapping_survey.php" method="post" enctype="multipart/form-data">
                            <div class="form-body">
								...
								<div class="form-group row">
                                    <label class="col-md-2" for="kcontact_cabut">KKONTAK CABUT</label>
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
